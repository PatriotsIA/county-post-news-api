...
County weather uses the public, no-key `https://api.weather.gov` service plus the public U.S. Drought Monitor county-statistics service and adds no IAM policy or secret parameter. The SAM environment supplies an identifying `NWS_USER_AGENT`; update its domain/contact if the application identity changes. Defaults are 86,400 seconds for point mappings, 600 seconds for forecasts/observations, 180 seconds for alerts and public weather responses, 21,600 seconds for weekly drought conditions, and 5,000 ms per request. See the official [NWS API documentation](https://www.weather.gov/documentation/services-web-api), [NWS alerts documentation](https://www.weather.gov/documentation/services-web-alerts), and [U.S. Drought Monitor web-service documentation](https://www.droughtmonitor.unl.edu/DmData/DataDownload/WebServiceInfo.aspx).
