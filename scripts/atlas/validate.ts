...
const plausibleRanges: Record<string, [number, number]> = {
  ...
  "rent-cost-burden-rate": [0, 100],
  "median-real-estate-taxes": [0, 100_000],
  ...
  "uninsured-rate": [0, 100],
  "agriculture-mining-employment": [0, 20_000_000],
  "voting-age-population": [0, 20_000_000],
  "internet-subscription-rate": [0, 100],
  "no-vehicle-households-rate": [0, 100],
  "work-from-home-rate": [0, 100],
  "drive-alone-commuter-rate": [0, 100],
